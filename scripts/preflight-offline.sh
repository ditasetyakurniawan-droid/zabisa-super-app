...
./scripts/verify-dt58-sonar-new-code-coverage.sh || fail 'DT5-DT8 Sonar New Code coverage test invariants failed'
pass 'DT5-DT8 Sonar New Code behavioural coverage invariants'

./scripts/verify-dt58-source.sh || fail 'DT5-DT8 controlled rollout invariants failed'
pass 'DT5-DT8 backup, migration, GitOps and internal acceptance controls'
